...
const Feature = () => {
  return (
    <div className="relative overflow-hidden bg-white mx-10 md:mx-36">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          ...
          <div>
            <div className="mt-10">
              ...
              <a
                href="#"
                className="inline-block rounded-md border border-transparent bg-primary px-8 py-3 text-center font-medium text-white hover:border-white"
              >
                Explore Trip
              </a>
            </div>
